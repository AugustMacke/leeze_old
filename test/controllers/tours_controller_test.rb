...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { description: @tour.description, teaser: @tour.teaser, title: @tour.title, url: @tour.url }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { description: @tour.description, teaser: @tour.teaser, title: @tour.title, url: @tour.url }
    assert_redirected_to tour_path(assigns(:tour))
  end
